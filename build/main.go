...
func CallDeploy() error {
	...
	addr, ts, _, err := contracts.DeployPdbank(auth, testClient, "yekai233")
	if err != nil {
...
func CallBankName() error {
	...
	//使用之前部署得到的合约地址
	//NewPdbank 合约调用的入口
	pd, err := contracts.NewPdbank(common.HexToAddress("0xD55E88D9156355C584982Db2C96dD1C2c63788C2"), testClient)
	if err != nil {
...
func main() {
	...
	//CallBankName()
	//CallDeposit()
	//MakeAuth("0x791443d21a76e16cc510b6b1684344d2a5ce751c", "123")
}
